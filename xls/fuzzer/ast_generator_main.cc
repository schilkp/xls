...
ABSL_FLAG(bool, generate_proc, true, "Generate a proc.");

ABSL_FLAG(bool, emit_stateless_proc, true, "Emit only stateless procs.");
...
absl::Status RealMain() {
  ...
  std::cout << "// min pipeline stages: " << result.min_stages << std::endl;
  std::cout << result.module->ToString() << std::endl;
